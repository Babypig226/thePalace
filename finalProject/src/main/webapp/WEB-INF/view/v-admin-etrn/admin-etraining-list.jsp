...
<body class="subpage">
    ...
    <section id="one" class="wrapper style2">
        <div class="inner">
            <div class="box">
                <div class="content">
                    <h2 class="align-center">직원교육 목록</h2>
                            ...
                            <tbody>
                            	<c:forEach items = "${list}" var = "e" >
                            		<tr>
                            			...
                            			<td><a href = "/etrn/detail?etrnNo=${e.trainingNo}">${e.curriculumName}</a></td>
                            			<td>${e.trainingTerm}</td>
                            			<td>${e.traineeMaxnum}</td>
                            			<td>${e.necessity}</td>
                            		</tr>
                            	</c:forEach>
                            </tbody>
                            <tfoot>
                                ...
                                <tr align = "right">
                                    <td colspan="6" align = "right">
                                        ...
                                        <a href="/etrn/regist" class="button">강의등록</a>
                                    </td>
                                </tr>
                            </tfoot>
                        </table>
